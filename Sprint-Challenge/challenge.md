...
In the very limited experience I have with code review, the most important thing to me is readability. Many things contribute to that, such as style and formatting. If the code is readable, then it is much easier to see what is going on, and to figure out how that person was able to solve the problem at hand. Another thing I look for is is discriptive varible names. Those will also help with the read ability of the code, and make it easier to understand the flow and logic. 

Containers allow you to run your code in an isolated environment, away from your base OS. This allows you to easily reporoduce the enviroment you ran the code in. This makes it easier to get things working on new machines. With containers you do not have to worry about what is installed on each individual computer. Instead you can use a container image that will run the same on every computer you use it on. That will make deplying and using new programs much easier. It also makes it so you don't have to really worry about dependencies, you just need to container software installed.  
